    ...
    <div class="panel panel-default">
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <br/>
                                {!! Form::textarea('content', Request::old('content'), ['id' => 'htmleditor', 'class' => 'form-control ckeditor']) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="title">Title</label>
                                {!! Form::text('title', Request::old("title"), ['id' => 'title', 'class'=>'form-control']) !!}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('slug', Request::old("slug"), ['id'=>'slug', 'tabindex' => '-1', 'class'=>'form-control']) !!}
                            </div>
                            <hr>
                            <div class="form-group">
                                {!! Form::label('published', 'Status') !!}
                                {!! Form::select('published', [0 => 'Draft', 1 => 'Live'], Request::old("published"), ['class' => 'select', 'style' => 'display:block']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="panel-metadata">
                    <div class="form-group">
                        ...
                        {!! Form::select('tags[]', $available_tags, Request::old("tags"), ['id'=>'tags','placeholder'=>'Adtags..','multiple'=>'multiple', 'class' => 'input-tags']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('meta_description', Request::old("meta_description"), ['class'=>'form-control']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        'nofollow'=>'Nofollow',
                        'both'=>'Noindex'
                        ], Request::old("meta_robots", 'all'), ['id'=>'tags','placeholder'=>'Robot options..']) !!}
                    </div>
                </div>

                <div class="tab-pane" id="panel-css">
                    <br/>
                    {!! Form::textarea('css', Request::old("css"), array('id' => 'css-editor', 'class' => 'form-control css_editor')) !!}
                </div>
                <div class="tab-pane" id="panel-js">
                    <br/>
                    {!! Form::textarea('js', Request::old("js"), array('id' => 'js-editor', 'class' => 'js_editor form-control')) !!}
                </div>
            </div>
        ...
        <div class="panel-footer">
            ...
            <label class="inline-checkbox" title="Set as index page" data-toggle="tooltip">
                &nbsp {!! Form::checkbox('is_index', 1, Request::old('is_index')) !!} Default page
            </label>
        </div>
    </div>
    {!! Form::close() !!}
